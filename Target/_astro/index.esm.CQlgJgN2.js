	...
	G = {
		...
		encodeByteArray(t, e) {
			...
			for (let r = 0; r < t.length; r += 3) {
				...
				let _ = ((o & 15) << 2) | (l >> 6),
					E = l & 63;
				c || ((E = 64), i || (_ = 64)), s.push(n[R], n[m], n[_], n[E]);
			}
			return s.join("");
		},
		encodeString(t, e) {
			return this.HAS_NATIVE_SUPPORT && !e
				? btoa(t)
				: this.encodeByteArray(W(t), e);
		},
		decodeString(t, e) {
			return this.HAS_NATIVE_SUPPORT && !e
				? atob(t)
				: ee(this.decodeStringToByteArray(t, e));
		},
		decodeStringToByteArray(t, e) {
			...
			for (let r = 0; r < t.length; ) {
				...
				if ((++r, a == null || o == null || l == null || m == null))
					throw new te();
				const _ = (a << 2) | (o >> 4);
				if ((s.push(_), l !== 64)) {
					const E = ((o << 4) & 240) | (l >> 2);
 ...
 * limitations under the License.
 */
const ae = () => se().__FIREBASE_DEFAULTS__,
	ie = () => {
	...
	he = () => {
		var t;
		return (t = ce()) === null || t === void 0 ? void 0 : t.config;
	}; /**
 * @license
 * Copyright 2017 Google LLC
 *
...
const Se = (t, e) => e.some((n) => t instanceof n);
let P, F;
function Ce() {
	return (
		P ||
		(P = [IDBDatabase, IDBObjectStore, IDBIndex, IDBCursor, IDBTransaction])
	);
}
function Ae() {
	return (
...
function Be(t) {
	...
	return (
		e
			.then((n) => {
				n instanceof IDBCursor && Y.set(n, t);
			})
			.catch(() => {}),
		N.set(e, t),
		e
...
let B = {
	get(t, e, n) {
		if (t instanceof IDBTransaction) {
			...
			if (e === "objectStoreNames") return t.objectStoreNames || X.get(t);
			if (e === "store")
...
function Me(t) {
	return t === IDBDatabase.prototype.transaction &&
		...
		? function (e, ...n) {
				...
				return X.set(s, e.sort ? e.sort() : [e]), d(s);
			}
		: Ae().includes(t)
			? function (...e) {
					return t.apply(v(this), e), d(Y.get(this));
				}
			: function (...e) {
...
function $e(t) {
	return typeof t == "function"
		? Me(t)
		: (t instanceof IDBTransaction && Oe(t),
			Se(t, Ce()) ? new Proxy(t, B) : t);
}
function d(t) {
	if (t instanceof IDBRequest) return Be(t);
	if (I.has(t)) return I.get(t);
	const e = $e(t);
	return e !== t && (I.set(t, e), N.set(e, t)), e;
}
const v = (t) => N.get(t);
function Ne(t, e, { blocked: n, upgrade: s, blocking: r, terminated: a } = {}) {
	const i = indexedDB.open(t, e),
		o = d(i);
	return (
		s &&
			i.addEventListener("upgradeneeded", (c) => {
				s(d(i.result), c.oldVersion, c.newVersion, d(i.transaction), c);
			}),
		n &&
			i.addEventListener("blocked", (c) =>
...
function x(t, e) {
	...
	const a = async function (i, ...o) {
		...
		return (
			s && (l = l.index(o.shift())),
			(await Promise.all([l[n](...o), r && c.done]))[0]
		);
	};
	return w.set(e, a), a;
}
Te((t) => ({
	...t,
	get: (e, n, s) => x(e, n) || t.get(e, n, s),
	has: (e, n) => !!x(e, n) || t.has(e, n),
})); /**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * limitations under the License.
 */
const p = new we("@firebase/app"),
	Fe = "@firebase/app-compat",
	xe = "@firebase/analytics-compat",
	Ve = "@firebase/analytics",
	je = "@firebase/app-check-compat",
	ke = "@firebase/app-check",
	ze = "@firebase/auth",
	Ue = "@firebase/auth-compat",
	We = "@firebase/database",
	Ge = "@firebase/database-compat",
	Je = "@firebase/functions",
	Ke = "@firebase/functions-compat",
	Ye = "@firebase/installations",
	Xe = "@firebase/installations-compat",
	Ze = "@firebase/messaging",
	qe = "@firebase/messaging-compat",
	Qe = "@firebase/performance",
	et = "@firebase/performance-compat",
	tt = "@firebase/remote-config",
	nt = "@firebase/remote-config-compat",
	rt = "@firebase/storage",
	st = "@firebase/storage-compat",
	at = "@firebase/firestore",
	it = "@firebase/vertexai-preview",
	ot = "@firebase/firestore-compat",
	ct = "firebase"; /**
 * @license
 * Copyright 2019 Google LLC
 *
...
const ht = "[DEFAULT]",
	lt = {
		...
		[Fe]: "fire-core-compat",
		[Ve]: "fire-analytics",
		[xe]: "fire-analytics-compat",
		[ke]: "fire-app-check",
		[je]: "fire-app-check-compat",
		[ze]: "fire-auth",
		[Ue]: "fire-auth-compat",
		[We]: "fire-rtdb",
		[Ge]: "fire-rtdb-compat",
...
function St(t, e = {}) {
	...
	const s = Object.assign(
			{ name: ht, automaticDataCollectionEnabled: !1 },
			e,
		),
		r = s.name;
	if (typeof r != "string" || !r)
		throw u.create("bad-app-name", { appName: String(r) });
	if ((n || (n = he()), !n)) throw u.create("no-options");
	const a = T.get(r);
	if (a) {
		if (C(n, a.options) && C(s, a.config)) return a;
		throw u.create("duplicate-app", { appName: r });
	}
	const i = new Ee(r);
	for (const c of M.values()) i.addComponent(c);
	const o = new ut(n, s, i);
	return T.set(r, o), o;
}
function y(t, e, n) {
	var s;
	let r = (s = lt[t]) !== null && s !== void 0 ? s : t;
	n && (r += `-${n}`);
	const a = r.match(/\s|\//),
		i = e.match(/\s|\//);
	if (a || i) {
	...
	$(new D(`${r}-version`, () => ({ library: r, version: e }), "VERSION"));
} /**
 * @license
 ...
 * limitations under the License.
 */
const pt = "firebase-heartbeat-database",
	mt = 1,
...
async function gt(t) {
	try {
		const n = (await Z()).transaction(g),
			s = await n.objectStore(g).get(q(t));
		return await n.done, s;
	} catch (e) {
		if (e instanceof b) p.warn(e.message);
		else {
			const n = u.create("idb-get", { originalErrorMessage: e?.message });
			p.warn(n.message);
		}
	}
}
async function k(t, e) {
	try {
		const s = (await Z()).transaction(g, "readwrite");
		await s.objectStore(g).put(e, q(t)), await s.done;
	} catch (n) {
		if (n instanceof b) p.warn(n.message);
		else {
			const s = u.create("idb-set", { originalErrorMessage: n?.message });
			p.warn(s.message);
		}
	}
}
...
class Et {
	...
	async getHeartbeatsHeader() {
		...
		if (
			...
			return "";
		const n = z(),
			{ heartbeatsToSend: s, unsentEntries: r } = yt(
				this._heartbeatsCache.heartbeats,
			),
...
function yt(t, e = bt) {
	...
	for (const r of t) {
		...
		if (a) {
			if ((a.dates.push(r.date), U(n) > e)) {
				a.dates.pop();
				break;
			}
		} else if ((n.push({ agent: r.agent, dates: [r.date] }), U(n) > e)) {
			n.pop();
			break;
		}
		s = s.slice(1);
 ...
 */
function It(t) {
	$(new D("platform-logger", (e) => new He(e), "PRIVATE")),
		$(new D("heartbeat", (e) => new Et(e), "PRIVATE")),
		y(O, V, t),
		y(O, V, "esm2017"),
		y("fire-js", "");
}
...
export {
	b as FirebaseError,
	ht as _DEFAULT_ENTRY_NAME,
	j as _addComponent,
	T as _apps,
	M as _components,
	$ as _registerComponent,
	dt as _serverApps,
	St as initializeApp,
	y as registerVersion,
};
